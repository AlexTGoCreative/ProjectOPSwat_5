...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Aici ai putea adăuga logica pentru trimiterea datelor
    ...
    // Afișează un mesaj de succes (în practică ai folosi un toast sau notificare)
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">alexandru.tulbure@example.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white">Work Status</h3>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://github.com/alexandru-tulbure"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-lg flex items-center justify-center hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors duration-200"
                >
